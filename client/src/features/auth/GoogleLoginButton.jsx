 ...
 * This component provides a "Login with Google" button that redirects to our backend
 * OAuth endpoint, which then redirects to Google's login page.
 * When clicked, this redirects the user to /api/auth/google on your backend,
